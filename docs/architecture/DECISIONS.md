...
| [0004](adr/0004-postgres-for-local-rls-testing.md) | Plain Postgres (not full Supabase CLI) for Sprint 0 local RLS verification | Accepted, superseded in Sprint 1 |
